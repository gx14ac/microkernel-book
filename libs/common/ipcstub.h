...
#define IPCSTUB_MSGID2STR                                                      \
    (const char *[]) {                                                         \
        ...
        [51] = "tcpip_connect", [52] = "tcpip_connect_reply",                  \
                                                                               \
        [53] = "tcpip_listen", [54] = "tcpip_listen_reply",                    \
                                                                               \
        [55] = "tcpip_close", [56] = "tcpip_close_reply",                      \
                                                                               \
        [57] = "tcpip_write", [58] = "tcpip_write_reply",                      \
                                                                               \
        [59] = "tcpip_read", [60] = "tcpip_read_reply",                        \
                                                                               \
        [61] = "tcpip_dns_resolve", [62] = "tcpip_dns_resolve_reply",          \
                                                                               \
        [63] = "tcpip_data",                                                   \
                                                                               \
        [64] = "tcpip_closed",                                                 \
