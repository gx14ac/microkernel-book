...
#define TCPIP_LISTEN_MSG            63
#define TCPIP_LISTEN_REPLY_MSG      64
...
#define IPCSTUB_MSGID2STR                                                      \
    (const char *[]) {                                                         \
        [1] = "exception",                                                     \
                                                                               \
        [2] = "page_fault", [3] = "page_fault_reply",                          \
                                                                               \
        [4] = "notify",                                                        \
                                                                               \
        [5] = "notify_irq",                                                    \
        ...
        [6] = "notify_timer",                                                  \
                                                                               \
        [7] = "async_recv", [8] = "async_recv_reply",                          \
                                                                               \
        [9] = "ping", [10] = "ping_reply",                                     \
                                                                               \
        [11] = "spawn_task", [12] = "spawn_task_reply",                        \
                                                                               \
        [13] = "destroy_task", [14] = "destroy_task_reply",                    \
                                                                               \
        [15] = "service_lookup", [16] = "service_lookup_reply",                \
                                                                               \
        [17] = "service_register", [18] = "service_register_reply",            \
                                                                               \
        [19] = "watch_tasks", [20] = "watch_tasks_reply",                      \
                                                                               \
        [21] = "task_destroyed",                                               \
                                                                               \
        [22] = "vm_map_physical", [23] = "vm_map_physical_reply",              \
                                                                               \
        [24] = "vm_alloc_physical", [25] = "vm_alloc_physical_reply",          \
                                                                               \
        [26] = "blk_read", [27] = "blk_read_reply",                            \
                                                                               \
        [28] = "blk_write", [29] = "blk_write_reply",                          \
                                                                               \
        [30] = "net_open", [31] = "net_open_reply",                            \
                                                                               \
        [32] = "net_recv",                                                     \
                                                                               \
        [33] = "net_send", [34] = "net_send_reply",                            \
                                                                               \
        [35] = "fs_open", [36] = "fs_open_reply",                              \
                                                                               \
        [37] = "fs_close", [38] = "fs_close_reply",                            \
                                                                               \
        [39] = "fs_read", [40] = "fs_read_reply",                              \
                                                                               \
        [41] = "fs_write", [42] = "fs_write_reply",                            \
                                                                               \
        [43] = "fs_readdir", [44] = "fs_readdir_reply",                        \
                                                                               \
        [45] = "fs_mkfile", [46] = "fs_mkfile_reply",                          \
                                                                               \
        [47] = "fs_mkdir", [48] = "fs_mkdir_reply",                            \
                                                                               \
        [49] = "fs_delete", [50] = "fs_delete_reply",                          \
                                                                               \
        [51] = "tcpip_connect", [52] = "tcpip_connect_reply",                  \
                                                                               \
        [53] = "tcpip_close", [54] = "tcpip_close_reply",                      \
                                                                               \
        [55] = "tcpip_write", [56] = "tcpip_write_reply",                      \
                                                                               \
        [57] = "tcpip_read", [58] = "tcpip_read_reply",                        \
                                                                               \
        [59] = "tcpip_dns_resolve", [60] = "tcpip_dns_resolve_reply",          \
                                                                               \
        [61] = "tcpip_data",                                                   \
                                                                               \
        [62] = "tcpip_closed", [63] = "tcpip_listen",                          \
        [64] = "tcpip_listen_reply",                                           \
    }
